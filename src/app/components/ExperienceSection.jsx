...
const experiencias = [
  ...
  },
  {
    ...
    descripcion: 'Diseño y puesta en marcha de una plataforma de observabilidad sobre el producto basada en Elastic Stack. Ingesta de logs. Creación de métricas. Creación del sistema de alarmado. Diseño de dashboards. Uso de lenguajes de scripting (PowerShell/Bash) para automatizar tareas y gestionar equipos de forma ágil.',
    icon: "<ArrowUpOnSquareIcon />",
  },
  {
    puesto: 'Data Analyst',
    ...
    descripcion: 'Resolución de incidencias relacionadas con el producto de la empresa. Mantenimiento de BDs Microsoft SQL Server. Generación de informes para clientes. Automatizaciones sobre las bases de datos. Automatización de procedimientos de mantenimiento.',
    icon: "<ArrowUpOnSquareIcon />",
  },
  {
